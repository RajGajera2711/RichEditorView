...
public enum RichEditorDefaultOption: RichEditorOption {
    ...
    public static let all: [RichEditorDefaultOption] = [
        ...
        .alignLeft, .alignCenter, .alignRight, .image, .link, .FontChange
    ]
    ...
    public var image: UIImage? {
        ...
        case .FontChange: name = "text-font"
        }
    ...
    public var title: String {
        ...
        case .FontChange: return NSLocalizedString("FontChange", comment: "")
        }
    }
    ...
    public func action(_ toolbar: RichEditorToolbar) {
        ...
        case .FontChange:  toolbar.editor?.fontchange()
        }
    }
}
